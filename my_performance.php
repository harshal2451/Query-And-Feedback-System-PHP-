...
<body style="background:#f8f8f8;" onLoad="fetchReport()">
	...
	<div id="navigation" style="position:fixed;width:100%;">
		...
		include("connect.php");
		$fetch_userid = "select dept_id from admin where admin_uname='".$_SESSION['user_faculty']."'";
	...
	<div class="container-fluid" id="content">
		...
		<div id="main" style="margin:1px;margin-top:40px;">
			<div class="container-fluid">
                ...
                <div class="note">*This table is based on the feedback(s) you have got from studemts.</div>  
			</div>
    ...
    <div class="model1" id="model1">
		...
		<script type="text/javascript">
			...
			function fetchReport(){
				...
				xmlhttp.open("POST","ajax_fetchfacultyMyreport.php?dept_id="+dept_id,false);
				xmlhttp.send(null);
				document.getElementById("performence").innerHTML = xmlhttp.responseText;
                document.getElementById("main").style.display = "block";
                //QNA
                var xmlhttp = new XMLHttpRequest();
				xmlhttp.open("POST","ajax_fetchfacultyqna.php?dept_id="+dept_id,false);
				xmlhttp.send(null);
